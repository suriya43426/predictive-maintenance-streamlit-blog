...
image = Image.open("https://www.realsoluplus.com/wp-content/uploads/2020/03/pj001-1.jpg")
st.set_page_config(
	page_title="RUL",
    page_icon=":shark:",
    layout="centered",
...
def model_predi():
	...
	time_of_cycle = st.sidebar.select_slider("At give some point of time engine fail or not",list(range(1, df[df['Engine_No']==engine_id].shape[0]))) 
